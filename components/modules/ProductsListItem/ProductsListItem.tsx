...
import ProductSubtitle from '@/components/elements/ProductSubtilte/ProductSubtitle'
      ...
      item.type === 't-shirts' ? (
        <li className={styles.list__item_ad}>
          <Link
            ...
            className={`${stylesForAd.ad} ${styles.list__item_ad__inner}`}
          >
            <span className={styles.list__item_ad__inner}>
